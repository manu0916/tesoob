...
Framework: React 19 with Vinext/Vite. UI primitives combine Base UI, shadcn patterns, Lucide icons, and project CSS.

## Button

- Path: `components/ui/button.tsx`
- Description: Primitivo de botão reutilizável.
...
- Description: Campo de entrada reutilizável.
...
- Description: Área de texto reutilizável.
...
- Description: Primitivos de diálogo e sobreposição.
...
- Description: Primitivos de navegação por abas.
...
- Path: `components/site-link.tsx`
- Description: Link interno compartilhado.
...
- Path: `components/drop-countdown.tsx`
- Description: Contagem regressiva reutilizável.
...
export function DropCountdown({
  ...
  return (
    <div
      ...
      aria-label="Contagem regressiva para o lanÃ§amento"
